						...
						<tr>
							<th onClick={() => this.changeSort('id')} className="sort">
								...
								<span className={classNames({
									...
									'fa fa-caret-down': this.state.filter.sort === 'id' && this.state.filter.reverse
								})}></span>
							</th>
							<th onClick={() => this.changeSort('title')} className="sort">
								...
								<span className={classNames({
									...
									'fa fa-caret-down': this.state.filter.sort === 'title' && this.state.filter.reverse
								})}></span>
							</th>
							<th onClick={() => this.changeSort('company')} className="sort">
								...
								<span className={classNames({
									...
									'fa fa-caret-down': this.state.filter.sort === 'company' && this.state.filter.reverse
								})}></span>
							</th>
							<th onClick={() => this.changeSort('price')} className="sort">
								...
								<span className={classNames({
									...
									'fa fa-caret-down': this.state.filter.sort === 'price' && this.state.filter.reverse
								})}></span>
							</th>
							<th></th>
						</tr>
